...
Implementation authority for user onboarding: `.claude/skills/harness-init/SKILL.md`. Do not require Node.js, npm, npx, tsx, or the TypeScript maintainer scripts.

`harness-setup` is a deprecated alias. Maintainer detector debugging: `npx tsx scripts/harness-detect.mjs <path>` (no `/harness-detect` command in this repo).
