...
**Canonical procedure:** read and follow [`.claude/skills/harness-init/SKILL.md`](../skills/harness-init/SKILL.md) from start to finish. Do not shorten or skip phases.
